...
routes = [
        ...
        webapp2.Route(r'/xmas/<to_user:([A-Za-z_\d]+ ?)+?>/<from_user:([A-Za-z_\d]+ ?)+?>', handler='api.calls.Xmas', name='xmas'),
        webapp2.Route(r'/christmas/<to_user:([A-Za-z_\d]+ ?)+?>/<from_user:([A-Za-z_\d]+ ?)+?>', handler='api.calls.Xmas', name='xmas'),
]
